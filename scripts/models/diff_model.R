...
plot(a2, df$mean_conf2, type = 'l', col = rgb(0,0.6,0), ylim = c(0,1), lwd = 3, 
     xlab = 'Task difficulty (2 alt proportion size', ylab = 'Confidence', main = 'Difference model')
...
plot(a3, df$mean_conf3, type = 'l', col = 'orange', ylim = c(0,1),lwd = 3, 
     xlab = 'A3 proportion size', ylab = 'Confidence', main = 'Difference model')
